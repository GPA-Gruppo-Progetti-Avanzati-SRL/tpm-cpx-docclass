...
func (ub *FilterBuilder) AndActionIdEqualTo(aActionId int32) *FilterBuilder {
	ub.fb.And(sqlmapper.Criterion{Type: sqlmapper.SingleValue, Condition: "action_id = ", Value: aActionId})
	return ub
}
